      ...
      <section className={styles.uniformStoreWrapper}>
        ...
        <div className={styles.contentWrapper}>
          ...
          <p className={styles.textContent}>
            Нанесение – логотип Спартака идет стандартно на всю детскую и тренерскую экипировку. Лого - жаккардовый шеврон, звезды-вышивка.
            100% полиэстер. Легкий материал со влагоотводящими свойствами.
            <br />
            <br />
            Технология управления влажностью Dri-FIT сохранит тело сухим. Эластичный пояс со шнурком для регулировки размера. Вставки из
